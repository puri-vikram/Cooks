    ...
    return (
        <div className="container my-md-5 my-0">
            <div className="featured-cook-wrapper">
                ...
                <h3 className="Featured-cooks-heading fw-bold heading-color"><span className="text-success">{t('home.featured')}{' '}
                                ...
                                <Link to={`/cookreact/cook-details/${_l._id}`}>
                                    <div className="pb-4 me-0 me-md-2">
                                        <div className="featured-box-1">
                                            ...
                                            <div className="d-xs-flex d-block align-items-center justify-content-between mb-1">
...
export default TopFeaturedCooks;